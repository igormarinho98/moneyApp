...
import styles from "./ListAcountApplication.module.scss";
...
const ListAcountApplication = () => {
    
    
    const  accountId  = useParams();
    const urlDev = `http://localhost:3000/account/invest/${accountId}`;
...
export default ListAcountApplication;